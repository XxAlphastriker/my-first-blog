...
from blog.views import SignUpView, BienvenidaView, LogoutView, SignOutView, SignInView, UploadCurse
...
urlpatterns = [
    ...
    path(r'^cargar_curso/$', UploadCurse, name='carga')
]
